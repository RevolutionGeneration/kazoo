...
-spec maybe_force_originate_outbound(knm_number:number_options(), kz_json:object()) -> any().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_force_outbound(knm_number:number_options(), kapi_offnet_resource:req()) -> any().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_force_outbound_sms(knm_number:number_options(), kapi_offnet_resource:req()) -> any().
...
%% @end
%%--------------------------------------------------------------------
-spec local_extension(knm_number:number_options(), kapi_offnet_resource:req()) ->
                             sup_startchild_ret().
...
%% @end
%%--------------------------------------------------------------------
-spec local_sms(knm_number:number_options(), kapi_offnet_resource:req()) -> 'ok'.
...
-spec local_originate(knm_number:number_options(), kz_json:object()) -> any().
...
-spec create_loopback_endpoint(knm_number:number_options(), kz_json:object()) -> any().

...
%% @end
%%--------------------------------------------------------------------
-spec set_account_id(knm_number:number_properties(), kz_json:object()) ->
                            kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec set_ignore_display_updates(knm_number:number_properties(), kz_json:object()) ->
                                        kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec set_inception(knm_number:number_properties(), kz_json:object()) ->
                           kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_find_resource(knm_number:number_properties(), kz_json:object()) ->
                                 kz_json:object().
...
-spec maybe_format_destination(knm_number:number_properties(), kz_json:object()) -> kz_json:object().
    ...
    case kz_json:get_value(?CCV(<<"Resource-ID">>), JObj) of
        ...
        ResourceId ->
            case stepswitch_resources:get_props(ResourceId) of
                'undefined' -> JObj;
                Resource ->
                    stepswitch_formatters:apply(JObj, props:get_value(<<"Formatters">>, Resource, kz_json:new()), 'inbound')
            end
    end.
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_set_ringback(knm_number:number_properties(), kz_json:object()) ->
                                kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_set_transfer_media(knm_number:number_properties(), kz_json:object()) ->
                                      kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_lookup_cnam(knm_number:number_properties(), kz_json:object()) ->
                               kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_add_prepend(knm_number:number_properties(), kz_json:object()) ->
                               kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_blacklisted(knm_number:number_properties(), kz_json:object()) ->
                           kz_json:object().
...
%% @end
%%--------------------------------------------------------------------
-spec maybe_transition_port_in(knm_number:number_properties(), kz_json:object()) -> any().

...
-spec local_message_handling(kz_proplist(), kapi_offnet_resource:req()) -> 'ok'.
...
-spec route_req(ne_binary(), ne_binary(), kz_proplist(), kapi_offnet_resource:req()) -> kz_proplist().

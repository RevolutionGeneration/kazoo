...
-spec load_merge(ne_binary(), cb_context:context()) ->
                        cb_context:context().
-spec load_merge(ne_binary(), kz_json:object(), cb_context:context()) ->
                        cb_context:context().
-spec load_merge(ne_binary(), kz_json:object(), cb_context:context(), api_object()) ->
                        cb_context:context().
...
load_attachment(Doc, AName, Context) ->
    load_attachment({kz_doc:type(Doc), kz_doc:id(Doc)}, AName, Context).

-spec load_attachment(ne_binary(), ne_binary(), kz_proplist(), cb_context:context()) ->
                             cb_context:context().
...
should_filter(Val, FilterVal) ->
    try kz_json:decode(FilterVal) of

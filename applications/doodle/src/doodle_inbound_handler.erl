...
%% @end
%%--------------------------------------------------------------------
-spec set_account_id(ne_binary(), kz_proplist(), kz_json:object()) ->
                            kz_json:object().
...
-spec set_inception(ne_binary(), kz_proplist(), kz_json:object()) ->
                           kz_json:object().
...
-spec set_mdn(ne_binary(), kz_proplist(), kz_json:object()) ->
                     kz_json:object().
...
-spec set_static(ne_binary(), kz_proplist(), kz_json:object()) ->
                        kz_json:object().
...
-spec delete_headers(ne_binary(), kz_proplist(), kz_json:object()) ->
                            kz_json:object().
delete_headers(_, _, JObj) ->
    kz_api:remove_defaults(JObj).

-spec set_realm(ne_binary(), kz_proplist(), kz_json:object()) ->
                       kz_json:object().
set_realm(_, _, JObj) ->
